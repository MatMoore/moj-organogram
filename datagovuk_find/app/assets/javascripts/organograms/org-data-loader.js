var OrgDataLoader = {
    load: function (csvURL, organogramContainer) {
        // !!! If this regex fails, this uses the same URL for both files !!!
    ...
    buildTree: function(juniors, seniors) {
        ...
        if (topLevel.length == 1) {
            ...
            // this means we've failed to parse any top level posts from the Senior CSV
            // e.g. the permanent secretary
            // such posts are marked as reporting to 'XX'
        }
    },
